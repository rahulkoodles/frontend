    ...
    <>
      ...
      >
        ...
        <div className="mt-6 text-white flex justify-between gap-4 items-center">
          ...
          <div className="">
            <Radio.Group value="" className="border rounded-md">
              <Radio.Button value="large" className="text-white border-white border-r border-t-0 border-b-0">
                Strict
              </Radio.Button>
        ...
        <div className="px-6 py-4 pl-0 flex flex-col gap-2 overflow-y-auto max-h-[40vh]">
          {tokenList.map((tokenData, index) => (
            ...
            //     0xf805f7437C1D26c00bbd5B1445cc1D5eaB1A428A
            //   </span>
            // </div>
          ))}
